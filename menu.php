            ...
            <?php }elseif($ss == "A"){ ?>
             ...
             <a href="admin/index1.php?su" class="border-0 list-group-item d-flex justify-content-between align-items-center list-group-item-action">ผู้ดูแลระบบ <i class="fa fa-users text-muted fa-lg"></i></a>

             <a href="admin/index1.php?sc" class="border-0 list-group-item d-flex justify-content-between align-items-center list-group-item-action">จัดการแบบทดสอบ <i class="fa fa-pencil-square-o text-muted fa-lg"></i></a>
            ...
            <a href="admin/index1.php?in" class="border-0 list-group-item d-flex justify-content-between align-items-center list-group-item-action"> ข้อมูลคะแนนทั้งหมด <i class="fa fa-list-ol text-muted fa-lg"></i></a>


            <a href="admin/index1.php?send" class="border-0 list-group-item d-flex justify-content-between align-items-center list-group-item-action"> แจ้งเตือนสมาชิก <i class="fa fa-envelope text-muted fa-lg"></i></a>
