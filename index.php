   ...
   <div class="container">
     <div class="row">
      ...
      <div class="col-md-6"> <!-- ใส่วิดีโอตัวอย่าง -->
        <br><br>
        <iframe width="100%" height="75%" src="https://www.youtube.com/embed/pemmZKWrWhk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                ...
                <div class="container">
                  <div class="row">
                    <div class="col-md-12 text-center">
                      <button name="btn" class="btn text-dark mx-1" style="background: #FED497;">สมัครสมาชิก</button>
